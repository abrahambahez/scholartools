...
Se crea automáticamente con valores por defecto en el primer uso. Edítalo manualmente; los cambios se aplican en el siguiente comando `scht`.
...
```
scht --plain <comando>   # salida legible en tabla en lugar de JSON
```
